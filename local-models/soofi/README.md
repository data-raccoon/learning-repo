...
Reserved local-model family. Soofi is inventory-only until its artifact, license, runtime, endpoint contract, hardware limits, and evaluated capabilities are known.
