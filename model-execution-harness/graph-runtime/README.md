...
Advanced graph, transactional execution, rollback, quarantine, and managed
runtime support for the repository's model execution harness. The internal
Python package retains the compatibility name `agent_orchestrator`.
