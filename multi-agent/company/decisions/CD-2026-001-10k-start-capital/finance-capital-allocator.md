...
| The Cologne POC is still internal discovery; its core normalized three-product-group financial sample is open. | fact | `experiments/poc-001-cologne-public-spending/work-order.md`, Evidence and Closure |
| The POC audit assessed agent integration, data quality, and PDF goal fitness as conditional and prohibited external distribution. | fact | `experiments/poc-001-cologne-public-spending/reviews/system-audit-2026-07-17/audit-report.md`, Decision and Release Boundary |
