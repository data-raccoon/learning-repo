...
`data_analytics_engineer` is the single accountable owner and writer for `experiments/poc-001-cologne-public-spending/**` during this Work Order.
...
| --- | --- | --- |
| `experiments/poc-001-cologne-public-spending/**` | `data_analytics_engineer` | `finance_capital_allocator`, `legal_risk_governance`, `venture_product_lead` |
