...
> Scope: experiments 01–03 and the constrained local model used for them. Cloud-model
> cost, latency, and full-file repair conclusions are documented separately in
