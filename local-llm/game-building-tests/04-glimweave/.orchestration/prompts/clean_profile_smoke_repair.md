Strengthen only `game-building-tests/04-glimweave/smoke.js`. Read it once, then edit it on
...
After editing, run
`py -3 game-building-tests/04-glimweave/tools/verify_glimweave.py` from the workspace if
