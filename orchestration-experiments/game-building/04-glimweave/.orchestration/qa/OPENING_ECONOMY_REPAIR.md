...
**Files changed:**
- `04-glimweave/data/game-data.json`: baseReservoirCapacity 100 → 150
- `04-glimweave/src/state.js`: create() reservoir 0→135, totalGlimCaptured 0→135; resetForRetuning() reservoir 0→135
