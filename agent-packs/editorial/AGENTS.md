...
| Agent | Definition |
|---|---|
| Developmental editor | `agent-definitions/developmental-editor.md` |
| Line editor | `agent-definitions/line-editor.md` |
| Copyeditor | `agent-definitions/copyeditor.md` |
| Proofreader | `agent-definitions/proofreader.md` |
| Sensitivity reader | `agent-definitions/sensitivity-reader.md` |
